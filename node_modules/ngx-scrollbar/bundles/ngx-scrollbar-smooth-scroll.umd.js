(function (global, factory) {
    ...
    (global = global || self, factory((global['ngx-scrollbar'] = global['ngx-scrollbar'] || {}, global['ngx-scrollbar']['smooth-scroll'] = {}), global.ng.core, global.ng.common, global.ng.cdk.coercion, global.ng.cdk.platform, global.rxjs, global.rxjs.operators, global.BezierEasing));
}(this, (function (exports, core, common, coercion, platform, rxjs, operators, BezierEasing) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SmoothScrollManager = /** @class */ (function () {
        ...
        function (el) {
            ...
            return (/** @type {?} */ ((/** @type {?} */ (this._onGoingScrolls.set(el, new rxjs.Subject()))).get(el)));
        };
        /**
        ...
        function (scrollable, customOptions) {
            if (common.isPlatformBrowser(this._platform)) {
                ...
                /** @type {?} */
                var options = __assign({}, ((/** @type {?} */ (this._defaultOptions))), customOptions, ((/** @type {?} */ ({
        ...
        function (scrollable, target, customOptions) {
            ...
            /** @type {?} */
            var options = __assign({}, customOptions, {
        ...
        /** @nocollapse */ SmoothScrollManager.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function SmoothScrollManager_Factory() { return new SmoothScrollManager(core.ɵɵinject(common.DOCUMENT), core.ɵɵinject(core.PLATFORM_ID), core.ɵɵinject(SMOOTH_SCROLL_OPTIONS, 8)); }, token: SmoothScrollManager, providedIn: "root" });
