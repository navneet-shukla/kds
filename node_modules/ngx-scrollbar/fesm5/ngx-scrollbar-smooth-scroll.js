...
import { InjectionToken, Injectable, Inject, PLATFORM_ID, Optional, ɵɵdefineInjectable, ɵɵinject, Directive, ElementRef, NgModule } from '@angular/core';
...
var SmoothScrollManager = /** @class */ (function () {
    ...
    /** @nocollapse */ SmoothScrollManager.ngInjectableDef = ɵɵdefineInjectable({ factory: function SmoothScrollManager_Factory() { return new SmoothScrollManager(ɵɵinject(DOCUMENT), ɵɵinject(PLATFORM_ID), ɵɵinject(SMOOTH_SCROLL_OPTIONS, 8)); }, token: SmoothScrollManager, providedIn: "root" });
